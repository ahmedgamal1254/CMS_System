                    ...
                    <div class="row align-items-end ">
                        <div class="col-lg-8">
                            <div class="page-header-title text-left-rtl">
                                <div class="d-inline">
                                    <h3 class="lite-text ">Catogeries</h3>
                                    <span class="lite-text text-gray">Catogeries information</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                ...
                <tbody>
                  @forelse ($cat as $item)
                    <tr>
                        ...
                        <td><a href="{{ route('cat_post',$item->id) }}">{{ $item->name }}</a></td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('del_cat',$item->id) }}" class="btn btn-danger">ok</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <a href="{{ route('edit_cat',$item->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                            </div>
                        </td>
                    </tr>
                  @empty
