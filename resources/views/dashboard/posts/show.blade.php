    ...
    <main class="bmd-layout-content">
        ...
        <div class="container">
            ...
            <form action="{{ route('search') }}" method="get">
                <div class="row justify-content-md-center">
                    <div class="form-group flex-form-search-post col-lg-8">
                        <input type="text" name="search" placeholder="search for posts" class="form-control" id="">
            ...
            <form action="{{ route('filter_post') }}" method="get">
                ...
                <div class="row">
                  <div class="col-lg-5">
                    <input type="date" class="form-control" placeholder="date 1" name="start_date">
                  </div>
                  <div class="col-lg-5">
                    <input type="date" class="form-control" placeholder="date 2" name="end_date">
                  </div>
                  <div class="col-lg-2">
