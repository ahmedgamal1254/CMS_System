...
@section('content')
    <main class="bmd-layout-content">
        ...
        <div class="container">
            ...
            <form action="{{ route('update_post') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="form-row">
                    <div class="col">
                    ...
                    <div class="col">
                      <input type="text" name="tags" value="{{ $post->tags }}" class="form-control" placeholder="tags of post">
                    </div>
                </div>

                <input type="hidden" name="cat_old" value="{{ $post->cat_id }}">
                ...
                <div class="form-row">
                    ...
                    <select class="form-control" name="cat" id="exampleFormControlSelect2">
                        <option value="{{ $post->cat_id }}">choose item</option>
                        @foreach ($cat as $item)
                ...
                <div class="form-group">
                    ...
                    <input id="x" type="hidden" value="{{ $post->content }}" name="content"><trix-editor input="x"></trix-editor>
                </div>
